...
- **Image Viewer** displays images interactively with other tools.
...
* **Scatter Plot**, **Histogram**, and **Density Plot** display numerical data, where data points can be clicked to display images (latter feature coming soon).
...
in the laboratories of David M. Sabatini and Polina Golland at the Whitehead Institute for Biomedical Research and MIT's CSAIL. Adam Fraser currently leads the development of CellProfiler Analyst. CellProfiler Analyst is primarily tested on MacOS 10.4, 10.5, and Windows XP, and to a lesser extent Linux. It has also been shown to work on MacOS 10.6. Running the software from Linux currently requires use of the source code, which is beyond the scope of this document.

CellProfiler Analyst is distributed under the GNU General Public License version 2 (see LICENSE.txt).
